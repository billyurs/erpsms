...
def addstudentdetails(request):
    if request.POST:
        ...
        if tenantid_of_req_user:
            personobj = Person()
            persondict = personobj.createobj(firstname=request.POST.get('firstname', ''),
                                             middlename=request.POST.get('middlename', ''),
                                             lasttname=request.POST.get('lasttname', ''),
                                             stduentid=request.POST.get('stduentid', ''),
                                             email=request.POST.get('email', ''),
                                             phno=request.POST.get('phno', ''), gender=request.POST.get('gender', ''),
                                             address=request.POST.get('address', ''),
                                             peronjson=request.POST.get('peronjson', ''),
                                             notes=request.POST.get('notes', ''), tenantid=tenantid_of_req_user)
            studentobj = Student()
...
def addparentdetails(request):
    ...
    if request.POST:
        ...
        if tenantid_of_req_user:
            ...
            parentobj.createobj(personid=persondict, studentid=studentjson,
                                parentjson=request.POST.get('parentjson', {}),
                                mobile=request.POST.get('mobile', ''), notes=request.POST.get('notes', ''),
                                tenantid=tenantid_of_req_user)
    ...
    if request.POST:
        ...
        if tenantid_of_req_user:
            ...
            teacherobj.createobj(personid=persondict, teacheridemail=request.POST.get('email', ''),
                                 subjectdetails=request.POST.get('subjectdetails', {}),
                                 mobile=request.POST.get('mobile', ''),
                                 teacherjson=request.POST.get('teacherjson', {}), notes='',
                                 tenantid=tenantid_of_req_user)
